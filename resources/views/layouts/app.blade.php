...
<html lang="en">
<head>
<title>Mağaza | @yield('title')</title>
<meta charset="utf-8">
									...
									<li class="hassubs">
										...
										<ul>
                                            @foreach ($categories as $category)
                                                <li style="white-space: nowrap"><a href="{{route('category', $category->alias)}}">{{$category->name}}</a></li>
                                            @endforeach
										</ul>
									</li>
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(user/images/home_slider_1.jpg)"></div>
		...
		<div class="container">
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{asset('user/images/icon_1.svg')}}" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{asset('user/images/icon_2.svg')}}" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{asset('user/images/icon_3.svg')}}" alt=""></div>
...
@show
	...
	<footer class="footer">
		<div class="footer_background" style="background-image:url(/user/images/footer.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
